...
import { EditPost, GetPostContent } from "@/services/PostApi";
...
const PostEdit2 = () => {
    ...
    }, [navigate, description, title, userTags, selectedBoard, post_id]);

    // 移除沒有討論版的課程
    const courseData = state.data.filter(c => c.boards && c.boards.length > 0);
